...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '@s.whatsapp.net'), ' ', 'bayurizky554@gmail.com', true],
         [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), ' ', 'bayurizky554@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: wm,
					mediaUrl: sgc,
					description: 'Kaguya-MultiDevice',
					previewType: "PHOTO",
					thumbnail: await (await fetch(thumb)).buffer(),
					sourceUrl: "https://youtube.com/c/BAYUOFC",					
				}
			}
		}
		global.fpayment = {
		...
		global.fakeig = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            ...
            mediaType: "VIDEO",
            description: "https://Instagram.com/bayurxzky.65", 
...
global.fakefb = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            mediaUrl: "https://Facebook.com/BayuRizkyAnanda",
            mediaType: "VIDEO",
            description: "https://www.Facebook.com/BayuRizkyAnanda", 
            title: 'Kaguya-MultiDevice',
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
